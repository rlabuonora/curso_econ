...
4. Analizar [esta noticia](katoen_el_pais.pdf).
...
- ¿Cuál es la cantidad y el precio si el monopolio no está regulado?
- ¿Cuál es el precio y la cantidad eficiente para el mercado?
- ¿Qué precio y cantidad regiría si el monopolio se regulara según la regla del costo medio?
- ¿Cuál es la ventaja de esta regla sobre la del costo marginal?

6. Escuchar [esta entrevista](https://delsol.uy/notoquennada/sebastianfleitas/defensa-de-la-competencia-perdio-prestigio-en-caso-con-philip-morris-1) a [Sebastián Fleitas](http://www.sebastianfleitas.com/) y contestar las siguientes preguntas:
...
- ¿Cuál es el diagnóstico de Fleitas sobre el funcionamiento actual de la Comisión de Defensa de la Competencia?


5. Leer [este artículo](https://www.vox.com/recode/2020/10/6/21505027/congress-big-tech-antitrust-report-facebook-google-amazon-apple-mark-zuckerberg-jeff-bezos-tim-cook) sobre el mercado de tecnología en EUA.

Explique cuáles son las principales prácticas anticompetitivas de las empresas analizadas. Explique por qué el gobierno de EUA aplica políticas con el objetivo de eliminar estas prácticas.
