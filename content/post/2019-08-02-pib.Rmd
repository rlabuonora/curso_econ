...
5. El siguiente gráfico compara el PIB per cápita de 5 países que se encontraban en posiciones similares a comienzos del siglo XX. Comentar la evolución entre 1900 y 2000.
```{r}
...
maddison %>% 
  ...
  labs(x="Año", y="PIB per cápita", caption="Angus Maddison")
```